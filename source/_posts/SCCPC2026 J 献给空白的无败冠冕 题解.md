...
$$
x_i=a_{1,i+1},\qquad y_i=a_{2,i}\qquad (1\le i\lt n).
$$
...
$$
\sum_{i=t}^{p-1}(x_i-y_i)>0\qquad (t\lt p),
$$
...
$$
x_i=\mathrm{ux}_i,\qquad y_i=\mathrm{ly}_i\qquad (i\lt p).
$$
